<div id="topbar" class="topbar header-mode-3">
    <div class="topbar-main">
        <div class="row">
            ...
            <div id="popup_login">
                ...
                <?php endif;?>
                <a href="<?php echo \ahura\app\mw_options::get_mod_header_cta_btn_url();?>" class="cta_button"><?php echo \ahura\app\mw_options::get_mod_header_cta_btn_text();?></a>
                <?php if(get_theme_mod('ahorua_show_mini_cart')):?>
                <?php \ahura\app\mini_cart::init_mini_cart(3);?>
                <?php endif;?>    
        </div>
        </div>
        <div class="row ah_menu_wrapper">
            <div class="col-md-3 cats-list<?php if(!is_front_page() OR !get_theme_mod( 'openmenuinfrontpage') ){ ?> isnotfront<?php } ?> mobile_hide">
                <span class="cats-list-title">
                    <span><i class="fa fa-bars"></i></span>
                    <span class="menu-title"><?php echo \ahura\app\mw_options::get_mod_header_cats_menu_title(); ?></span>
                </span>
